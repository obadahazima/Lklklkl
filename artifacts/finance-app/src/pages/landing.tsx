    ...
    <div className="min-h-screen bg-background flex flex-col" dir="rtl">
      <header className="flex items-center justify-between px-6 py-4 border-b border-border">
        <div className="flex items-center gap-2">
          <img src={`${basePath}/logo.jpg`} alt="Billy Bills AI" className="w-8 h-8 rounded-lg" />
          <span className="font-bold text-foreground text-lg">Billy Bills AI</span>
        </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-16 text-center">
        <img src={`${basePath}/logo.jpg`} alt="Billy Bills AI" className="w-20 h-20 rounded-3xl mb-6 shadow-lg" />
