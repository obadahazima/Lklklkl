...
export default function SignUpPage() {
  ...
  const handleSSOSignUp = useCallback(
        ...
        setLocalError(
          err?.errors?.[0]?.message ??
            (provider === "oauth_google"
              ? "فشل التسجيل بـ Google"
              : "فشل التسجيل بـ Apple")
        );
      } finally {
        setSsoLoading(null);
      }
  ...
  const handleSubmit = async () => {
    ...
    if (error) {
      setLocalError(error.message ?? "فشل إنشاء الحساب");
      return;
    }
  ...
  const handleVerify = async () => {
    ...
    if (signUp.status === "complete") {
      ...
      setLocalError("التحقق لم يكتمل، حاول مجدداً");
    }
  };
    ...
    return (
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>أرسلنا رمز تحقق إلى {email}</Text>
        </View>
        <View style={styles.card}>
          ...
          >
            {isLoading ? (
              ...
              <Text style={styles.buttonText}>تحقق وأكمل التسجيل</Text>
            )}
          </Pressable>
          <Pressable style={styles.linkBtn} onPress={handleResend}>
            <Text style={styles.linkText}>أعد إرسال الرمز</Text>
          </Pressable>
          <Pressable
    ...
    >
      ...
      >
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Billy Bills AI</Text>
        </View>
        ...
        <View style={styles.card}>
          ...
          >
            {ssoLoading === "google" ? (
              ...
              <>
                <GoogleIcon />
                <Text style={styles.ssoBtnText}>التسجيل بـ Google</Text>
              </>
            )}
          </Pressable>
          ...
          <View style={styles.row}>
            <Text style={styles.muted}>لديك حساب؟ </Text>
