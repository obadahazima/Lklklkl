...
export function buildStatementHtml(opts: ExportOptions): string {
...
body{font-family:-apple-system,'Segoe UI',Tahoma,Arial,sans-serif;padding:24px;color:#1e293b;direction:${s.dir};font-size:12px}
...
export async function exportStatementPdf(opts: ExportOptions): Promise<void> {
