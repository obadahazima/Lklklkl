...
export const translations = {
  ar: {
    ...
    chatWelcome:
      "هلا! أنا بيلي، مساعدك المالي الذكي بالتطبيق. بقدر أجاوبك عن أي شي بحساباتك — الأرصدة، ذمم الزبائن، أرباح الرحلات، مصاريف الاستديوهات — وكمان أضيفلك وأعدّللك معاملات وزبائن ورحلات مباشرة من هون. جرّبني!",
  ...
  en: {
    ...
    chatWelcome:
      "Hey! I'm Billy, your AI financial assistant. I can answer anything about your accounts — balances, client receivables, trip profits, studio expenses — and I can also add or edit transactions, clients, and trips for you right here. Try me!",
