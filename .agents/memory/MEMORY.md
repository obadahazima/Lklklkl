...
- [Voice entity matching](voice-entity-matching.md) — spoken client/trip names matched cross-language (Ar↔En) inside Gemini via parse-voice; trust server-validated AI ids on frontend
